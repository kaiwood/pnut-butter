...
module.exports = (api) => {
  return {
    ...
    pmChannelFor(...userIds) {
      return api.request(`/users/me/channels/existing_pm`, { params: { ids: userIds }});
    },
     ...
     */
    unread(params = {}) {
      return api.request('/users/me/channels/num_unread/pm', { params: params });
    },
    ...
    subscribers(channelId, params = {}) {
      return api.request(`/channels/${channelId}/subscribers`, { params: params });
    },
