...
const publicEndpoints = require('./public_endpoints');
const privateEndpoints = require('./private_endpoints');
...
const pnut = () => {
  ...
  const api = {
    ...
    call(endpoint, { httpMethod = 'GET', resultAs = 'json', data = {} } = {}) {
      let auth = {};
      if (this.token !== '') {
        auth = {
  ...
  return Object.assign(
    {
      ...
      custom(endpoint, method = 'GET', data = {}) {
        ...
        return api.call(`${endpoint}`, { httpMethod: method, data: data })
      },
